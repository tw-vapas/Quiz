...
export default function CreateQuizSection() {
  return (
    <div className="flex-1 grid grid-cols-1 lg:grid-cols-4 gap-3 md:gap-4 p-4 md:p-6 h-[calc(100vh-4rem)] min-h-0 overflow-y-auto lg:overflow-hidden bg-slate-50 dark:bg-slate-950 transition-colors duration-300">
